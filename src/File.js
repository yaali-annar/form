...
import { string, number, arrayOf, func, bool, node, oneOfType } from 'prop-types'

const File = ({ allowedExtensions, explanation, name, maxSize, multipart, onChange }) => {
    ...
    <div>
      ...
      {error && (
        <div className="error-message">
          <FormattedMessage id={error} values={errorMessageValues} />
        </div>
      )}
    </div>
  )
